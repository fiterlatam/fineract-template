...
public enum JobName {
    ...
    ALLY_COLLECTION_SETTLEMENT("Ally Collection Settlement"), RECALCULATE_LOAN_INTEREST_AFTER_MAXIMUM_LEGAL_RATE_CHANGE(
            "Recalculate Loan Interest After Maximum Legal Rate Change"), ALLYPURCHASESETTLEMENT("Ally Purchase Settlement");
