...
public final class BankChequeApiConstants {
    ...
    public static String GUARANTEE_DPI = "dpi";
    ...
    public static String PROCESS_ERRORS = "processErrors";
    ...
    public static final Set<String> BATCH_CHEQUE_REQUEST_RESPONSE_DATA_PARAMETERS = new HashSet<>(
            Arrays.asList(ID_PARAM_NAME, REQUESTED_BY_ID, REQUESTED_BY_USERNAME, REQUESTED_BY_EMAIL, STATUS, DATE_REQUESTED, DATE_PROCESSED,
                    CHEQUE_IDS, PROCESS_ERRORS));
