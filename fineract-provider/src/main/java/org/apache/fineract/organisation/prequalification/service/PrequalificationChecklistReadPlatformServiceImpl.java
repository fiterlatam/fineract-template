...
public class PrequalificationChecklistReadPlatformServiceImpl implements PrequalificationChecklistReadPlatformService {
    ...
    public PrequalificationChecklistData retrieveHardPolicyValidationResults(final Integer prequalificationId) {
        ...
        final List<String> prequalificationColumnHeaders = new ArrayList<>(List.of("prequalificationName"));
        ...
        for (HardPolicyCategoryData policy : groupPolicies) {
            prequalificationColumnHeaders.add(policy.getName());
        ...
        final List<String> memberColumnHeaders = new ArrayList<>(List.of("clientId", "clientName", "dpi"));
        individualPolicies.forEach(policy -> memberColumnHeaders.add(policy.getName()));
