...
@Service
@CommandType(entity = "PREQUALIFICATIONS", action = "REJECTRENEGOTIATION")
public class ProcessRejectRenegotiationRequestCommandHandler implements NewCommandSourceHandler {

    private final PrequalificationWritePlatformService prequalificationWritePlatformService;

    @Autowired
    public ProcessRejectRenegotiationRequestCommandHandler(
