 ...
 * under the License.
 */
package org.apache.fineract.organisation.bankAccount.serialization;
 ...
 */
@Component
public final class BankAccountCommandFromApiJsonDeserializer {

    /**
     * The parameters supported for this command.
     */
    private final Set<String> supportedParameters = BankAccountConstants.BankAccountSupportedParameters.getAllValues();

    private final FromJsonHelper fromApiJsonHelper;

    @Autowired
    public BankAccountCommandFromApiJsonDeserializer(final FromJsonHelper fromApiJsonHelper) {
    ...
    public void validateForCreate(final String json) {
        ...
        final DataValidatorBuilder baseDataValidator = new DataValidatorBuilder(dataValidationErrors)
                .resource(BankAccountConstants.BANK_ACCOUNT_RESOURCE_NAME);
