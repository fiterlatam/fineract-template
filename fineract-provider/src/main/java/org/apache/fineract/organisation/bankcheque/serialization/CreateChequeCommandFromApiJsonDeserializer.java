...
public class CreateChequeCommandFromApiJsonDeserializer extends AbstractFromApiJsonDeserializer<CreateChequeCommand> {

    private final FromJsonHelper fromApiJsonHelper;

    @Override
    public CreateChequeCommand commandFromApiJson(String json) {
        ...
        return this.fromApiJsonHelper.fromJson(json, CreateChequeCommand.class);
    }
