 ...
 * under the License.
 */
package org.apache.fineract.organisation.bank.serialization;
...
public final class BankCommandFromApiJsonDeserializer {
     ...
     */
    private final Set<String> supportedParameters = BankConstants.BankSupportedParameters.getAllValues();

    private final FromJsonHelper fromApiJsonHelper;

    @Autowired
    public BankCommandFromApiJsonDeserializer(final FromJsonHelper fromApiJsonHelper) {
