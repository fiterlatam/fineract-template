...
public final class PrequalificationMemberCommandFromApiJsonDeserializer {
    ...
    private final Set<String> supportedParameters = new HashSet<>(Arrays.asList("id", "clientId", "name", "dpi", "dob", "locale",
            "dateFormat", "amount", "puente", "individual", "workWithPuente", "productId", "members", "prequalilficationTimespan", "status",
            "groupPresident", PrequalificatoinApiConstants.memberRequestedAmountParamName));

    private final Set<String> supportedParametersForUpdate = new HashSet<>(Arrays.asList("id", "clientId", "name", "dpi", "dob", "locale",
            "dateFormat", "amount", "puente", "individual", "productId", "members", "prequalilficationTimespan", "status", "groupPresident",
            PrequalificatoinApiConstants.memberRequestedAmountParamName));
