...
public enum PrequalificationSubStatus {
    ...
    COMPLETED(300, "prequalification.status.completed"),
    BURO_EVIDENCE(400, "prequalification.status.buroevidence"),
    RE_VALIDATE(500, "prequalification.status.revalidate"),
