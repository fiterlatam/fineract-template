...
public class NumberToWordsConverter {
    ...
    public static class SpanishConverter {
        ...
        protected static String convertPower(final int _number, final int _power) {
            if (_number == 1) {
                return SINGLE_POWER_NAMES[_power];
            } else {
                final StringBuilder ret = new StringBuilder();
                if (_number != 0) {
                    ret.append(convertLessThanOneThousand(_number)).append(' ').append(getPowerNames()[_power]);
                }
                return ret.toString();
            }
        }
        ...
        public static String convertToWords(final long _number) {
            ...
            if (_number == 0) {
                ...
                final String result = new StringBuilder().append(convertPower(quintillions, 5)).append(' ')
                        .append(convertPower(quadrillions, 4)).append(' ').append(convertPower(trillions, 3)).append(' ')
                        .append(convertPower(billions, 2)).append(' ').append(convertPower(millions, 1)).append(' ')
                        .append(convertPower(thousands, 0)).append(' ').append(convertLessThanOneThousand(hundreds)).toString();
