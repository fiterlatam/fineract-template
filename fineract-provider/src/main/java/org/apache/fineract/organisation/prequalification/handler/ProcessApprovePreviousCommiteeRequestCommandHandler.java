...
@Service
@CommandType(entity = "PREQUALIFICATIONS", action = "APPROVEPREVIOUSCOMMITEE")
public class ProcessApprovePreviousCommiteeRequestCommandHandler implements NewCommandSourceHandler {

    private final PrequalificationWritePlatformService prequalificationWritePlatformService;

    @Autowired
    public ProcessApprovePreviousCommiteeRequestCommandHandler(
