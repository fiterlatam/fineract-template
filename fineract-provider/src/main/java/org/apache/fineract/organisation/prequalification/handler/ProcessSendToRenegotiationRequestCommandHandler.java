...
@Service
@CommandType(entity = "PREQUALIFICATIONS", action = "SENDTORENEGOTIATION")
public class ProcessSendToRenegotiationRequestCommandHandler implements NewCommandSourceHandler {

    private final PrequalificationWritePlatformService prequalificationWritePlatformService;

    @Autowired
    public ProcessSendToRenegotiationRequestCommandHandler(
