...
public class CenterGroupCommandFromApiJsonDeserializer {
    ...
    public void validateForCreate(final String json) {
        ...
        final Integer locationId = this.fromApiJsonHelper.extractIntegerWithLocaleNamed(
                CenterGroupConstants.CenterGroupSupportedParameters.CENTER_GROUP_LOCATION.getValue(), element);
        baseDataValidator.reset().parameter(CenterGroupConstants.CenterGroupSupportedParameters.CENTER_GROUP_LOCATION.getValue())
                .value(locationId).notNull().integerGreaterThanZero();
