...
public class PrequalificatoinApiConstants {

    public static final String PREQUALIFICATION_RESOURCE_NAME = "prequalification";
    ...
    public static final String membersParamName = "members";
