...
@Service
@CommandType(entity = "PREQUALIFICATIONS", action = "APPROVERENEGOTIATION")
public class ProcessApproveRenegotiationRequestCommandHandler implements NewCommandSourceHandler {

    private final PrequalificationWritePlatformService prequalificationWritePlatformService;

    @Autowired
    public ProcessApproveRenegotiationRequestCommandHandler(
