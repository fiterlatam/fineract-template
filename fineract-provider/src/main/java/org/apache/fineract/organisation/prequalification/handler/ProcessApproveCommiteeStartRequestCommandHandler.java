...
@Service
@CommandType(entity = "PREQUALIFICATIONS", action = "SENDTOCOMMITEE")
public class ProcessApproveCommiteeStartRequestCommandHandler implements NewCommandSourceHandler {

    private final PrequalificationWritePlatformService prequalificationWritePlatformService;

    @Autowired
    public ProcessApproveCommiteeStartRequestCommandHandler(
