...
public final class CalculateLoanScheduleQueryFromApiJsonHelper {
    ...
    static final Set<String> SUPPORTED_PARAMETERS = new HashSet<>(Arrays.asList(LoanApiConstants.idParameterName,
            ...
            LoanApiConstants.INTEREST_RATE_POINTS, LoanApiConstants.POINT_OF_SALE_CODE, LoanApiConstants.CLIENT_ID_NUMBER,LoanApiConstants.DISCOUNT_VALUE,LoanApiConstants.DISCOUNT_TRANSFER_VALUE));
