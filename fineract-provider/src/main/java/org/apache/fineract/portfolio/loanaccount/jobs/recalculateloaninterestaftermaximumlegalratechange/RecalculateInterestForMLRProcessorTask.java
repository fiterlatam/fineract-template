...
public class RecalculateInterestForMLRProcessorTask implements Callable<Void> {

    private final RecalculateInterestForMLRProcessor recalculateInterestForMLRProcessor;
    @Setter
