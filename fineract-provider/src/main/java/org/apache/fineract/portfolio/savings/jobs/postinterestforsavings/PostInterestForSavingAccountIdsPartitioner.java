...
public class PostInterestForSavingAccountIdsPartitioner implements Partitioner {
    ...
    public PostInterestForSavingAccountIdsPartitioner(List<Long> savingsAccountIds){
    ...
    private Map<String, ExecutionContext> getPartitions(int partitionSize) {
        ...
        for (Long loanId : savingsAccountIds) {
            ...
            List<Long> data = (List<Long>) executionContext.get("savingsAccountIdsForInterestPostingWorker");
            data.add(loanId);
            remainingSpace++;
        }
        return partitions;
    ...
    private void createNewPartition(Map<String, ExecutionContext> partitions, int partitionIndex) {
        ...
        executionContext.put("savingsAccountIdsForInterestPostingWorker", new ArrayList<Long>());
