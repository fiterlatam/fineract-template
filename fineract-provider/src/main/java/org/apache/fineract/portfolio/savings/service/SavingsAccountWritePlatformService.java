...
public interface SavingsAccountWritePlatformService {
    ...
    CommandProcessingResult depositAndHoldToClientGuaranteeAccount(BigDecimal depositAmount, BigDecimal requiredAmount, Long clientId, LocalDate transactionDate);
}
