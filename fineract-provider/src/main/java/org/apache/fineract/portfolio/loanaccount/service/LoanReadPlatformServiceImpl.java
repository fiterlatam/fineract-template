...
public class LoanReadPlatformServiceImpl implements LoanReadPlatformService {
    ...
    public LoanApprovalData retrieveApprovalTemplate(final Long loanId) {
        final Loan loan = this.loanRepositoryWrapper.findOneWithNotFoundDetection(loanId, true);
        return new LoanApprovalData(loan.getLoanRepaymentScheduleDetail().getPrincipal().getAmount(), DateUtils.getBusinessLocalDate(),
    ...
    public LoanTransactionData retrieveDisbursalTemplate(final Long loanId, boolean paymentDetailsRequired) {
        ...
        return LoanTransactionData.loanTransactionDataForDisbursalTemplate(transactionType,
                loan.getExpectedDisbursedOnLocalDateForTemplate(), loan.getPrincpal().getAmount(), loan.getPrincpal().getAmount(),
    ...
    private static final class LoanMapper implements RowMapper<LoanAccountData> {
        ...
        public String loanSchema() {
            return "l.id as id, l.account_no as accountNo, l.external_id as externalId, l.fund_id as fundId, f.name as fundName,"
                    ...
                    + " l.loan_officer_id as loanOfficerId, s.display_name as loanOfficerName, l.total_origination_fees as originationFees, "
                    ...
                    + " l.total_vatoninterest_outstanding, la.interest_vat_overdue_derived as total_vatoninterest_overdue, l.total_vatoncharge_expected,"
                    ...
                    + " l.total_vaton_penaltycharge_expected, l.total_vaton_penaltycharge_paid, l.total_vaton_penaltycharge_writtenoff, l.total_vaton_penaltycharge_waived,"
                    + " l.total_vaton_penaltycharge_outstanding, la.penalty_vat_overdue_derived as total_vaton_penaltycharge_overdue,"
        ...
        public LoanAccountData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            final BigDecimal originationFees = rs.getBigDecimal("originationFees");
            ...
            return LoanAccountData.basicLoanDetails(id, accountNo, status, externalId, clientId, clientAccountNo, clientName,
                    ...
                    fixedPrincipalPercentagePerInstallment, catRate, effectiveRate, isVatRequired, catRateWithVat, originationFees);
        }
    }
    ...
    private static final class LoanScheduleResultSetExtractor implements ResultSetExtractor<LoanScheduleData> {
        ...
        LoanScheduleResultSetExtractor(final RepaymentScheduleRelatedLoanData repaymentScheduleRelatedLoanData,
            ...
            this.originationFees = repaymentScheduleRelatedLoanData.getOriginationFees();
            this.outstandingLoanPrincipalBalance = this.disbursement.amount().add(this.originationFees);
        ...
        public String schema() {
            ...
            return " ls.loan_id as loanId, ls.installment as period, ls.fromdate as fromDate, ls.duedate as dueDate, ls.obligations_met_on_date as obligationsMetOnDate, ls.completed_derived as complete,"
                    ...
                    + " ls.vat_on_penalty_charges_expected_derived as vatOnPenaltyCharges, ls.vat_on_penalty_charges_paid_derived as vatOnPenaltyChargesPaid, "
                    + " ls.vat_on_penalty_charges_writtenoff_derived as vatOnPenaltyChargesWrittenOff, ls.vat_on_penalty_charges_waived_derived as vatOnPenaltyChargesWaived, "
                    + " ls.vat_on_penalty_charges_outstanding_derived as vatOnPenaltyChargesOutstanding, ls.vat_on_penalty_charges_overdue_derived as vatOnPenaltyChargesDerived "
        ...
        public LoanScheduleData extractData(final ResultSet rs) throws SQLException, DataAccessException {
            ...
            final LoanSchedulePeriodData disbursementPeriod = LoanSchedulePeriodData.disbursementOnlyPeriod(
                    this.disbursement.disbursementDate(), this.disbursement.amount().add(originationFees),
                    this.totalFeeChargesDueAtDisbursement, this.disbursement.isDisbursed(), null, null);
            ...
            if (disbursementData.isEmpty()) {
                ...
                totalPrincipalDisbursed = Money.of(monCurrency, this.disbursement.amount()).getAmount().add(originationFees);
            } else {
            ...
            Money totalVatOnPenaltyCharges = Money.zero(monCurrency);
            ...
            while (rs.next()) {
                ...
                final BigDecimal totalExpectedCostOfLoanForPeriod = interestExpectedDue.add(feeChargesExpectedDue)
                        .add(penaltyChargesExpectedDue).add(vatOnCharges).add(vatOnInterest).add(vatOnPenaltyCharges);
                ...
                final BigDecimal totalPaidForPeriod = principalPaid.add(interestPaid).add(feeChargesPaid).add(penaltyChargesPaid)
                        .add(vatOnChargesPaid).add(vatOnInterestPaid).add(vatOnPenaltyChargesPaid);
                ...
                totalVatOnPenaltyCharges = totalVatOnPenaltyCharges.plus(vatOnPenaltyCharges);
            ...
            return new LoanScheduleData(this.currency, periods, loanTermInDays, totalPrincipalDisbursed, totalPrincipalExpected.getAmount(),
                    ...
                    totalVatOnPenaltyCharges.getAmount());
        }
    ...
    private static final class LoanTransactionsMapper implements RowMapper<LoanTransactionData> {
        ...
        public String loanPaymentsSchema() {
            ...
            return " tr.id as id, tr.transaction_type_enum as transactionType, tr.transaction_date as " + sqlGenerator.escape("date")
                    ...
                    + " tr.vat_on_penalty_charges_portion as vatPenaltyChargesPortion, "
        ...
        public LoanTransactionData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            final BigDecimal vatPenaltyChargesPortion = JdbcSupport.getBigDecimalDefaultToZeroIfNull(rs, "vatPenaltyChargesPortion");
            ...
            loanTransactionData.setVatOnPenaltyCharges(vatPenaltyChargesPortion);
    ...
    @Override
    public Collection<OverdueLoanScheduleData> retrieveLoanWithOverdueInstallments(Long loanId, Long penaltyWaitPeriod,
    ...
    private static final class LoanRepaymentWaiverMapper implements RowMapper<LoanSchedulePeriodData> {
        ...
        public LoanSchedulePeriodData mapRow(ResultSet rs, @SuppressWarnings("unused") int rowNum) throws SQLException {
            ...
            final BigDecimal vatOnPenaltyCharges = null;
            ...
            return LoanSchedulePeriodData.repaymentPeriodWithPayments(loanId, period, fromDate, dueDate, obligationsMetOnDate, complete,
                    ...
                    totalActualCostOfLoanForPeriod, totalInstallmentAmount, vatOnInterest, vatOnCharges, vatOnPenaltyCharges);
        }
    }
    ...
    private static final class RepaymentTransactionTemplateMapper implements RowMapper<LoanTransactionData> {
        ...
        public String schema() {
            ...
            sqlBuilder.append(
                    "ls.vat_on_penalty_charges_expected_derived - coalesce(ls.vat_on_penalty_charges_paid_derived, 0) - coalesce(ls.vat_on_penalty_charges_writtenoff_derived, 0) - coalesce(ls.vat_on_penalty_charges_waived_derived, 0) as vatOnPenaltyChargesDue, ");
            sqlBuilder.append(
        ...
        public LoanTransactionData mapRow(ResultSet rs, int rowNum) throws SQLException {
            ...
            final BigDecimal vatOnPenaltyChargesDue = JdbcSupport.getBigDecimalDefaultToZeroIfNull(rs, "vatOnPenaltyChargesDue");
            final BigDecimal totalDue = principalPortion.add(interestDue).add(feeDue).add(penaltyDue).add(vatOnInterestDue)
                    .add(vatOnChargesDue).add(vatOnPenaltyChargesDue);
            final BigDecimal outstandingLoanBalance = null;
            final BigDecimal unrecognizedIncomePortion = null;
