 ...
 * under the License.
 */
package org.apache.fineract.portfolio.blacklist.handler;
...
public class BlackListClientCommandHandler implements NewCommandSourceHandler {
    ...
    @Autowired
    public BlackListClientCommandHandler(final BlacklistClientWritePlatformService blacklistClientWritePlatformService) {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        ...
        return this.blacklistClientWritePlatformService.addClientToBlacklist(command);
    }
}
