...
public class LoanHistoryArchivalTask implements Callable<Void> {
    ...
    private final LoanHistoryArchiver loanHistoryArchiver;
    @Setter
    ...
    public Void call() throws JobExecutionException {
        ...
        loanHistoryArchiver.archiveLoans();
        return null;
    }

    public void setLoansForArchival(List<LoanArchiveHistoryData> loanArchiveHistoryData) {
        this.loanHistoryArchiver.setLoansForArchival(loanArchiveHistoryData);
    }
}
