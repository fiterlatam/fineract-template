...
public class LoanCloseAsRescheduledForeclosureEventProcessor extends BaseCustomWebhookEventProcessorImpl {

    private final LoanCloseAsRescheduledEventProcessor loanCloseAsRescheduledEventProcessor;
    ...
    protected List<Map<String, String>> getSupportedEvents() {
        Map<String, String> loanCloseEvent = Map.of("entityName", "LOAN", "actionName", "FORECLOSURE");
    ...
    public Map<String, Object> generateSuccessResponse(CommandProcessingResult successResult) {
        return loanCloseAsRescheduledEventProcessor.generateSuccessResponse(successResult);
    }
}
