...
public enum InsuranceIncidentType {
    ...
    NOVEDAD_REDIFERIDO(5, "labels.inputs.insurance.incident.novedad.rediferido",
            "Novedad rediferido"), // Renamed notification type from FINAL_REFINANCED_CANCELLATION to NOVEDAD_REDIFERIDO
