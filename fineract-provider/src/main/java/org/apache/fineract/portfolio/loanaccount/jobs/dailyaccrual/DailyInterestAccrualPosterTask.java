...
public class DailyInterestAccrualPosterTask implements Callable<Void> {

    private final DailyInterestAccrualPoster dailyInterestAccrualPoster;
    @Setter
    ...
    public Void call() throws JobExecutionException {
        ...
        dailyInterestAccrualPoster.postDailyInterestAccruals();
        return null;
    }
