...
public class FacturaElectronicaMensualPosterTask implements Callable<Void> {

    private final FacturaElectronicaMensualPoster facturaElectronicaMensualPoster;
    @Setter
    ...
    public Void call() throws JobExecutionException {
        ...
        facturaElectronicaMensualPoster.processInvoice();
        return null;
    }
