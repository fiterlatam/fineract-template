...
@Setter
public abstract class CustomFieldValidationProcessor {

    private CustomFieldValidationProcessor nextCustomFieldValidationProcessor;

    private Object parentObject;
    private DataTableMetaData metData;
    private Map<String, String> dataParams;
    private Map<String, Object> auxliaryObjects;
