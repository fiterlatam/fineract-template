...
public final class LoanRepaymentConstants {
    ...
    public static final int TOTAL_OUTSTANDING_AMOUNT_COL = 6; // G
    public static final int LOAN_DISBURSEMENT_DATE_COL = 7; // H
    ...
    public static final int LOOKUP_ACCOUNT_NO_COL = 19;// T
    public static final int LOOKUP_PRODUCT_COL = 20;// U
    public static final int LOOKUP_PRINCIPAL_COL = 21;// V
    public static final int LOOKUP_TOTAL_OUTSTANDING_AMOUNT_COL = 22; // W
    public static final int LOOKUP_LOAN_DISBURSEMENT_DATE_COL = 23;// X
}
