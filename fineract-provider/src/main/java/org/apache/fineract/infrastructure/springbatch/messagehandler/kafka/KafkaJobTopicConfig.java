...
import org.apache.fineract.infrastructure.springbatch.messagehandler.conditions.kafka.KafkaRemoteJobTopicAutoCreateCondition;
...
public class KafkaJobTopicConfig {
    ...
    public KafkaAdmin admin() {
        Map<String, Object> props = new HashMap<>(
                fineractProperties.getRemoteJobMessageHandler().getKafka().getAdmin().getExtraPropertiesMap());
    ...
    public NewTopic jobTopic() {
        FineractProperties.KafkaTopicProperties topicProperties = fineractProperties.getRemoteJobMessageHandler().getKafka().getTopic();
