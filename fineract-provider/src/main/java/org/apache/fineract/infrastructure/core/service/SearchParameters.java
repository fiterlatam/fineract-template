...
public final class SearchParameters {
    ...
    public static SearchParameters forBlacklist(final String displayName, final String status, final Integer offset, final Integer limit,
            final String orderBy, final String sortOrder, final String dpiNumber) {
        ...
        return new SearchParameters(null, null, null, displayName, null, null, null, status, offset, maxLimitAllowed, orderBy, sortOrder,
