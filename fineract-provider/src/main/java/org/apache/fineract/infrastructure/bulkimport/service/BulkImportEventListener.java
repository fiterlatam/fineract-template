...
public class BulkImportEventListener implements ApplicationListener<BulkImportEvent> {
    ...
    public void onApplicationEvent(final BulkImportEvent event) {
        ...
        importHandler = switch (entityType) {
            ...
            case CLIENT_CUPO_INCREMENTS -> this.applicationContext.getBean("clientCupoIncrementImportHandler", ImportHandler.class);
            case CLIENT_CUPO_DECREMENTS -> this.applicationContext.getBean("clientCupoDecrementImportHandler", ImportHandler.class);
            ...
            case SALES_OF_INSURANCE_OR_ASSISTANCE ->
                this.applicationContext.getBean("saleOfInsuranceOrAssistanceImportHandler", ImportHandler.class);
            default ->
