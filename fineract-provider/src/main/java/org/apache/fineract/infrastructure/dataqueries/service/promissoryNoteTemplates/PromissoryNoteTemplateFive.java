...
public class PromissoryNoteTemplateFive {
    ...
    private String generate(JsonObject object) {
        ...
        try {
            ...
            writer.setPageEvent(new PromissoryNoteTemplateFive.HeaderFooterEvent(logo));
            ...
            String bodyText = String.format("""
                    ...
                    creditPurpose, "detalle", termText, disbursementDate, secondTermText, numberEqualsQuotas + " " + quotaAmount,
            ...
            String avalText = String.format("""
                            ...
                            Lugar y fecha de emisión: Municipio y Departamento de %s, %s de %s, del año dos mil %s.
                            """, guarantorName, guarantorDPIText, guarantorDPI, guarantorAddress, witnessName, witnessDpiText, witnessDpiNumber, department, date.getDayOfMonth(), date.getMonth().getDisplayName(TextStyle.FULL, new Locale("es")), date.getYear() - 2000
            );
