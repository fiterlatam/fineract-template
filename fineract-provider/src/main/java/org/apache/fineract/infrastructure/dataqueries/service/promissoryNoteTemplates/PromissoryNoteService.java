...
public interface PromissoryNoteService {
    ...
    CommandProcessingResult updatePromissoryNote(JsonCommand json);

    List<PromissoryNoteTemplateData> getPromissoryNoteTemplates();

    PromissoryNoteTemplateData retrievePromissoryNoteTemplate(Long id);
}
