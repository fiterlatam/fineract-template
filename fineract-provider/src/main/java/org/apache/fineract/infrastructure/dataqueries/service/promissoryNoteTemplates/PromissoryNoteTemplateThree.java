...
public class PromissoryNoteTemplateThree {
    ...
    private String generate(JsonObject object) {
        ...
        try {
            ...
            writer.setPageEvent(new PromissoryNoteTemplateThree.HeaderFooterEvent(logo));
            ...
            String avalText = String.format("""
                            ...
                            Lugar y fecha de emisión: Municipio y Departamento de %s, %s de %s, del año dos mil %s.
                            """, guarantorName, guarantorDPIText, guarantorDPI, guarantorAddress, department, date.getDayOfMonth(), date.getMonth().getDisplayName(TextStyle.FULL, new Locale("es")), date.getYear() - 2000
            );
