...
public interface SubChannelLoanProductReadWritePlatformService {

    List<SubChannelLoanProductData> findAllActive();

    List<SubChannelLoanProductData> findAllByProductId(Long productId);

    SubChannelLoanProductData findById(Long id);
