...
public final class SubChannelApiConstants {

    private SubChannelApiConstants() {

    }

    public static final String RESOURCE_NAME = "subchannel";
    ...
    public static final Set<String> REQUEST_DATA_PARAMETERS = new HashSet<>(Arrays.asList(localeParamName, dateFormatParamName, idParamName,
            channelIdParamName, nameParamName, descriptionParamName, activeParamName));
}
