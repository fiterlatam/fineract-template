...
public class ClientAllyApiResource {
    ...
    public Response downloadTemplate(@QueryParam("officeId") final Long officeId, @QueryParam("dateFormat") final String dateFormat) {
        ...
        return this.customWorkbookPopulatorService.getTemplate(CustomGlobalEntityType.CLIENT_ALLY.getCode(), officeId, null, dateFormat);
    }
    ...
    public String get(@Context final UriInfo uriInfo) {
        this.context.authenticatedUser().validateHasReadPermission(ClientAllyApiConstants.RESOURCE_NAME);
        return this.toApiJsonSerializer.serialize(this.allyCompensationRepository.findAll());
    }
