...
public interface CustomChargeTypeReadWritePlatformService {
    ...
    List<CustomChargeTypeData> findAllActive();

    List<CustomChargeTypeData> findAllByEntityId(Long chargeEntityId);

    CustomChargeTypeData findById(Long id);

    CommandProcessingResult create(JsonCommand command, Long customChargeTypeId);
