...
VALUES ("Percentage of members with their own business Policy Check", "Table", "Prequalification",
        "SELECT
            CASE
            WHEN (${membersPercentage} = 100) THEN 'GREEN'
            WHEN (${membersPercentage} < 100) THEN 'YELLOW'
            ELSE 'RED'
            END AS color", "Percentage of members with their own business Policy Check", 0, 0, 0);
