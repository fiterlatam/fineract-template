...
INSERT INTO pae_required_documents (`category_id`, `document_name`, `description`, `accepted_format`, `required`) VALUES ( (select id from m_code_value where code_id = (select id from m_code where code_name='PaeRequiredGuarantees' limit 1) and code_value='Fiador empresario' limit 1), 'Fotografias externas de la vivienda (con coordenadas)', 'Fotografias externas de la vivienda (con coordenadas)', 'PDF/IMAGE', b'1') ON DUPLICATE KEY UPDATE category_id = category_id, document_name=document_name;
INSERT INTO pae_required_documents (`category_id`, `document_name`, `description`, `accepted_format`, `required`) VALUES ( (select id from m_code_value where code_id = (select id from m_code where code_name='PaeRequiredGuarantees' limit 1) and code_value='Fiador empresario' limit 1), 'Constancia laboral  firmada y sellada - 1 año de antigüedad laboral', 'Constancia laboral  firmada y sellada - 1 año de antigüedad laboral', 'PDF/IMAGE', b'1') ON DUPLICATE KEY UPDATE category_id = category_id, document_name=document_name;
...
INSERT INTO pae_required_documents (`category_id`, `document_name`, `description`, `accepted_format`, `required`) VALUES ( (select id from m_code_value where code_id = (select id from m_code where code_name='PaeRequiredGuarantees' limit 1) and code_value='Fiador empresario' limit 1), 'Estado patrimonial', 'Estado patrimonial', 'PDF/IMAGE', b'1') ON DUPLICATE KEY UPDATE category_id = category_id, document_name=document_name;
