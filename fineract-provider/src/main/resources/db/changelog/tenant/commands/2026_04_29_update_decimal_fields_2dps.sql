...
ALTER TABLE PDA_Pagos MODIFY Monto DECIMAL(12,2);
ALTER TABLE PDA_Pagos MODIFY Monto_anterior DECIMAL(12,2);
ALTER TABLE PDA_Pagos MODIFY Monto_pago_programado DECIMAL(12,2);
ALTER TABLE acc_gl_journal_entry MODIFY amount DECIMAL(19,2);
ALTER TABLE acc_gl_journal_entry MODIFY office_running_balance DECIMAL(19,2);
ALTER TABLE acc_gl_journal_entry MODIFY organization_running_balance DECIMAL(19,2);
...
ALTER TABLE m_loan MODIFY annual_nominal_interest_rate DECIMAL(19,2);
ALTER TABLE m_loan MODIFY approved_principal DECIMAL(19,2);
ALTER TABLE m_loan MODIFY arrearstolerance_amount DECIMAL(19,2);
ALTER TABLE m_loan MODIFY fee_charges_charged_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY fee_charges_outstanding_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY fee_charges_repaid_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY fee_charges_waived_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY fee_charges_writtenoff_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY fixed_emi_amount DECIMAL(19,2);
ALTER TABLE m_loan MODIFY fixed_principal_percentage_per_installment DECIMAL(5,2);
ALTER TABLE m_loan MODIFY guarantee_amount_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY interest_charged_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY interest_outstanding_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY interest_rate_differential DECIMAL(19,2);
ALTER TABLE m_loan MODIFY interest_repaid_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY interest_waived_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY interest_writtenoff_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY max_outstanding_loan_balance DECIMAL(19,2);
ALTER TABLE m_loan MODIFY net_disbursal_amount DECIMAL(19,2);
ALTER TABLE m_loan MODIFY nominal_interest_rate_per_period DECIMAL(19,2);
ALTER TABLE m_loan MODIFY penalty_charges_charged_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY penalty_charges_outstanding_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY penalty_charges_repaid_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY penalty_charges_waived_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY penalty_charges_writtenoff_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY principal_amount DECIMAL(19,2);
ALTER TABLE m_loan MODIFY principal_amount_proposed DECIMAL(19,2);
ALTER TABLE m_loan MODIFY principal_disbursed_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY principal_outstanding_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY principal_repaid_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY principal_writtenoff_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY total_charges_due_at_disbursement_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY total_costofloan_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY total_expected_costofloan_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY total_expected_repayment_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY total_outstanding_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY total_overpaid_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY total_recovered_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY total_repayment_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY total_waived_derived DECIMAL(19,2);
ALTER TABLE m_loan MODIFY total_writtenoff_derived DECIMAL(19,2);
...
ALTER TABLE m_loan_arrears_aging MODIFY fee_charges_overdue_derived DECIMAL(19,2);
ALTER TABLE m_loan_arrears_aging MODIFY interest_overdue_derived DECIMAL(19,2);
ALTER TABLE m_loan_arrears_aging MODIFY penalty_charges_overdue_derived DECIMAL(19,2);
ALTER TABLE m_loan_arrears_aging MODIFY principal_overdue_derived DECIMAL(19,2);
ALTER TABLE m_loan_arrears_aging MODIFY total_overdue_derived DECIMAL(19,2);
ALTER TABLE m_loan_charge MODIFY amount DECIMAL(19,2);
ALTER TABLE m_loan_charge MODIFY amount_outstanding_derived DECIMAL(19,2);
ALTER TABLE m_loan_charge MODIFY amount_paid_derived DECIMAL(19,2);
ALTER TABLE m_loan_charge MODIFY amount_waived_derived DECIMAL(19,2);
ALTER TABLE m_loan_charge MODIFY amount_writtenoff_derived DECIMAL(19,2);
ALTER TABLE m_loan_charge MODIFY calculation_on_amount DECIMAL(19,2);
ALTER TABLE m_loan_charge MODIFY calculation_percentage DECIMAL(19,2);
ALTER TABLE m_loan_charge MODIFY charge_amount_or_percentage DECIMAL(19,2);
ALTER TABLE m_loan_charge MODIFY max_cap DECIMAL(19,2);
ALTER TABLE m_loan_charge MODIFY min_cap DECIMAL(19,2);
ALTER TABLE m_loan_charge_paid_by MODIFY amount DECIMAL(19,2);
...
ALTER TABLE m_loan_installment_charge MODIFY amount DECIMAL(19,2);
ALTER TABLE m_loan_installment_charge MODIFY amount_outstanding_derived DECIMAL(19,2);
ALTER TABLE m_loan_installment_charge MODIFY amount_paid_derived DECIMAL(19,2);
ALTER TABLE m_loan_installment_charge MODIFY amount_through_charge_payment DECIMAL(19,2);
ALTER TABLE m_loan_installment_charge MODIFY amount_waived_derived DECIMAL(19,2);
ALTER TABLE m_loan_installment_charge MODIFY amount_writtenoff_derived DECIMAL(19,2);
ALTER TABLE m_loan_interest_recalculation_additional_details MODIFY amount DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule MODIFY accrual_fee_charges_derived DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule MODIFY accrual_interest_derived DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule MODIFY accrual_penalty_charges_derived DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule MODIFY fee_charges_amount DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule MODIFY fee_charges_completed_derived DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule MODIFY fee_charges_waived_derived DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule MODIFY fee_charges_writtenoff_derived DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule MODIFY interest_amount DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule MODIFY interest_completed_derived DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule MODIFY interest_waived_derived DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule MODIFY interest_writtenoff_derived DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule MODIFY penalty_charges_amount DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule MODIFY penalty_charges_completed_derived DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule MODIFY penalty_charges_waived_derived DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule MODIFY penalty_charges_writtenoff_derived DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule MODIFY principal_amount DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule MODIFY principal_completed_derived DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule MODIFY principal_writtenoff_derived DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule MODIFY reschedule_interest_portion DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule MODIFY total_paid_in_advance_derived DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule MODIFY total_paid_late_derived DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule_history MODIFY fee_charges_amount DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule_history MODIFY interest_amount DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule_history MODIFY penalty_charges_amount DECIMAL(19,2);
ALTER TABLE m_loan_repayment_schedule_history MODIFY principal_amount DECIMAL(19,2);
...
ALTER TABLE m_loan_transaction MODIFY amount DECIMAL(19,2);
ALTER TABLE m_loan_transaction MODIFY fee_charges_portion_derived DECIMAL(19,2);
ALTER TABLE m_loan_transaction MODIFY interest_portion_derived DECIMAL(19,2);
ALTER TABLE m_loan_transaction MODIFY loan_topup_amount DECIMAL(19,2);
ALTER TABLE m_loan_transaction MODIFY net_accrued_interest DECIMAL(19,2);
ALTER TABLE m_loan_transaction MODIFY outstanding_loan_balance_derived DECIMAL(19,2);
ALTER TABLE m_loan_transaction MODIFY overpayment_portion_derived DECIMAL(19,2);
ALTER TABLE m_loan_transaction MODIFY penalty_charges_portion_derived DECIMAL(19,2);
ALTER TABLE m_loan_transaction MODIFY principal_portion_derived DECIMAL(19,2);
ALTER TABLE m_loan_transaction MODIFY unrecognized_income_portion DECIMAL(19,2);
ALTER TABLE m_loan_transaction_repayment_schedule_mapping MODIFY amount DECIMAL(19,2);
ALTER TABLE m_loan_transaction_repayment_schedule_mapping MODIFY fee_charges_portion_derived DECIMAL(19,2);
ALTER TABLE m_loan_transaction_repayment_schedule_mapping MODIFY interest_portion_derived DECIMAL(19,2);
ALTER TABLE m_loan_transaction_repayment_schedule_mapping MODIFY penalty_charges_portion_derived DECIMAL(19,2);
ALTER TABLE m_loan_transaction_repayment_schedule_mapping MODIFY principal_portion_derived DECIMAL(19,2);
...
ALTER TABLE m_savings_account MODIFY account_balance_derived DECIMAL(19,2);
ALTER TABLE m_savings_account MODIFY lockin_period_frequency DECIMAL(19,2);
ALTER TABLE m_savings_account MODIFY max_allowed_lien_limit DECIMAL(19,2);
ALTER TABLE m_savings_account MODIFY min_balance_for_interest_calculation DECIMAL(19,2);
ALTER TABLE m_savings_account MODIFY min_overdraft_for_interest_calculation DECIMAL(19,2);
ALTER TABLE m_savings_account MODIFY min_required_balance DECIMAL(19,2);
ALTER TABLE m_savings_account MODIFY min_required_opening_balance DECIMAL(19,2);
ALTER TABLE m_savings_account MODIFY nominal_annual_interest_rate DECIMAL(19,2);
ALTER TABLE m_savings_account MODIFY nominal_annual_interest_rate_overdraft DECIMAL(19,2);
ALTER TABLE m_savings_account MODIFY on_hold_funds_derived DECIMAL(19,2);
ALTER TABLE m_savings_account MODIFY overdraft_limit DECIMAL(19,2);
ALTER TABLE m_savings_account MODIFY total_annual_fees_derived DECIMAL(19,2);
ALTER TABLE m_savings_account MODIFY total_deposits_derived DECIMAL(19,2);
ALTER TABLE m_savings_account MODIFY total_fees_charge_derived DECIMAL(19,2);
ALTER TABLE m_savings_account MODIFY total_interest_earned_derived DECIMAL(19,2);
ALTER TABLE m_savings_account MODIFY total_interest_posted_derived DECIMAL(19,2);
ALTER TABLE m_savings_account MODIFY total_overdraft_interest_derived DECIMAL(19,2);
ALTER TABLE m_savings_account MODIFY total_penalty_charge_derived DECIMAL(19,2);
ALTER TABLE m_savings_account MODIFY total_savings_amount_on_hold DECIMAL(19,2);
ALTER TABLE m_savings_account MODIFY total_withdrawal_fees_derived DECIMAL(19,2);
ALTER TABLE m_savings_account MODIFY total_withdrawals_derived DECIMAL(19,2);
ALTER TABLE m_savings_account MODIFY total_withhold_tax_derived DECIMAL(19,2);
...
ALTER TABLE m_savings_account_transaction MODIFY amount DECIMAL(19,2);
ALTER TABLE m_savings_account_transaction MODIFY cumulative_balance_derived DECIMAL(19,2);
ALTER TABLE m_savings_account_transaction MODIFY overdraft_amount_derived DECIMAL(19,2);
ALTER TABLE m_savings_account_transaction MODIFY running_balance_derived DECIMAL(19,2);
ALTER TABLE m_savings_account_transaction_tax_details MODIFY amount DECIMAL(19,2);
