...
VALUES ("Add endorsement Policy Check", "Table", "Prequalification",
        "SELECT CASE
       ...
       ELSE 'RED'
  END AS color
  FROM m_client mc WHERE mc.id = ${clientId}", "Add endorsement Policy Check", 0, 0, 0);
