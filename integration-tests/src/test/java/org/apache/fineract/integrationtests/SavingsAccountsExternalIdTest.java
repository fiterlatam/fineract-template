...
public class SavingsAccountsExternalIdTest extends IntegrationTest {
    ...
    void updateSavingsAccountWithExternalId() {
        ...
        Response<PutSavingsAccountsAccountIdResponse> response = okR(fineract().savingsAccounts.update27(EXTERNAL_ID, request, ""));
    ...
    void retrieveSavingsAccountWithExternalId() {
        ...
        Response<GetSavingsAccountsAccountIdResponse> response = okR(fineract().savingsAccounts.retrieveOne37(EXTERNAL_ID, false, "all"));
    ...
    void deleteSavingsAccountWithExternalId() {
        ...
        request.setLocale(locale);
        request.setActivatedOnDate(formattedDate);
        Response<DeleteSavingsAccountsAccountIdResponse> response = okR(fineract().savingsAccounts.delete27(EXTERNAL_ID));
    ...
    void retrieveSavingsAccountWithExternalIdThirdTime() {
        ...
        Response<GetSavingsAccountsAccountIdResponse> response = Calls
                .executeU(fineract().savingsAccounts.retrieveOne37(EXTERNAL_ID, false, "all"));
