...
public class SavingsAccountsExternalIdTest extends IntegrationTest {
    ...
    void updateSavingsAccountWithExternalId() {
        ...
        Response<PutSavingsAccountsAccountIdResponse> response = okR(fineract().savingsAccounts.update23(EXTERNAL_ID, request, ""));
    ...
    void retrieveSavingsAccountWithExternalId() {
        ...
        Response<GetSavingsAccountsAccountIdResponse> response = okR(fineract().savingsAccounts.retrieveOne28(EXTERNAL_ID, false, "all"));
    ...
    void retrieveSavingsAccountWithExternalIdThirdTime() {
        ...
        Response<GetSavingsAccountsAccountIdResponse> response = Calls
                .executeU(fineract().savingsAccounts.retrieveOne28(EXTERNAL_ID, false, "all"));
