...
public class LoanRepaymentScheduleInstallment extends AbstractAuditableWithUTCDateTimeCustom
    ...
    public Money getPrincipalAccountedFor(final MonetaryCurrency currency) {
        return getPrincipalCompleted(currency).plus(getPrincipalWrittenOff(currency));
    }
    ...
    public void checkIfRepaymentPeriodObligationsAreMetAdvanced(final LocalDate transactionDate, final MonetaryCurrency currency,
        ...
        if (isForeclosing) {
            ...
            boolean lastInstallment = this.getId() == null
                    || Objects.equals(this.installmentNumber, this.getLoan().getRepaymentScheduleInstallments()
                            .get(this.getLoan().getLoanRepaymentScheduleInstallmentsSize() - 1).installmentNumber);
            if (this.obligationsMet && lastInstallment) {
                this.obligationsMetOnDate = transactionDate;
    ...
    public void updateComponents(LoanRepaymentScheduleInstallment copy, MonetaryCurrency currency) {
        ...
        this.setLastInstallmentOverpaidInActual(copy.isLastInstallmentOverpaidInActual);
