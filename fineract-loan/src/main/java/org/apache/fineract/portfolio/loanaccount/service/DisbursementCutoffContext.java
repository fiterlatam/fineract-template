...
public class DisbursementCutoffContext {
    ...
    /**
     * Get the total repaid amount from the current context
     */
    public static Money getTotalRepaid() {
        CutoffCalculationResult result = getCutoffResult();
        return result != null ? result.totalRepaid() : null;
    }

    /**
     * Get the total outstanding amount from the current context
     */
    public static Money getTotalOutstanding() {
        CutoffCalculationResult result = getCutoffResult();
        return result != null ? result.totalOutstanding() : null;
    }
    ...
    public static Money getTotalForgiven() {
        CutoffCalculationResult result = getCutoffResult();
        return result != null ? result.getTotalForgiven() : null;
    }
