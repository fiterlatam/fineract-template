...
/**
 * ThreadLocal context to store disbursement cutoff calculation results
 * to avoid duplicate calculations during disbursement operations.
 */
public class DisbursementCutoffContext {
     ...
     * 
     * @param pair the cutoff calculation result as ImmutablePair
     */
     ...
     * 
     * @param isAfterCutoff whether the disbursement is after cutoff
     */
     ...
     * 
     * @param installments the number of installments before the cutoff
     */
     ...
     * @param calculateInstallmentsToAddFunction function to calculate installments if context is not set
     * @return true if schedule recalculation is needed, false otherwise
     */
    ...
    public static boolean isContextSet() {
        return pairContext.get() != null || isAfterCutoffContext.get() != null || cutoffDate.get() != null || installmentsBeforeCutoff.get() != null;
    }
