...
select * from tmp_loanaccount tl where "ID" = '2400999358';

select * from tmp_loan_repayment_schedule tlrs where "PARENTACCOUNTKEY" = '8a444c5a9744ffd8019746e799500fd1' order by "DUEDATE";
